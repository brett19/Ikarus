...
const unsigned char CrcTable[ ] =
{
    ...
    0x23, 0x7D, 0x9F, 0xC1, 0x42, 0x1C, 0xFE, 0xA0, 0xE1, 0xBF, 0x5D, 0x03, 0x80, 0xDE, 0x2C, 0x62, 
    0x65, 0x3B, 0xD9, 0x87, 0x04, 0x5A, 0xB8, 0xE6, 0xA7, 0xF9, 0x1B, 0x45, 0xC6, 0x98, 0x7A, 0x24, 
    0x11, 0x4F, 0xAD, 0xF3, 0x70, 0x3E, 0xCC, 0x92, 0xD3, 0x8D, 0x6F, 0x31, 0xB2, 0xEC, 0x0E, 0x50, 
    ...
    0x8C, 0xD2, 0x30, 0x6E, 0xED, 0xB3, 0x51, 0x0F, 0x4E, 0x10, 0xF2, 0xAD, 0x2F, 0x71, 0x93, 0xCD, 
};
//*/
...
struct CPC
{
	...
	{
		int RealPakSize = *((unsigned short*)&buffer[0]);

		Head head = { 0 };
		head.EncryptValue = rand();
		head.AddTableValue = m_Ri[ key & 0x1FF ];
	...
	void Init( int key )
	{
		...
		m_Cr.SetType( TableFuncList[0x10] & 3 );
		for( int i = 0; i < 0x200; i++ )
		{
			do {
